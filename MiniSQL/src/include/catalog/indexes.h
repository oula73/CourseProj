...
private:
  ...
  Index *CreateIndex(BufferPoolManager *buffer_pool_manager) {
    // ASSERT(false, "Not Implemented yet.");
    index_id_t indexId = meta_data_->index_id_;
    ...
    void *mem = heap_->Allocate(sizeof(BP_TREE_INDEX));
    auto index = new(mem) BP_TREE_INDEX (indexId, key_schema_, buffer_pool_manager);
    return index;
  }
